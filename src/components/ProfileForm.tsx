  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: official
      ? {
          ...
          stewardLevel: official.stewardLevel
            ? official.stewardLevel
            : undefined,
      ...
      : {
          ...
          courseDesignerLevel: undefined,
          isSteward: "false",
          stewardLevel: undefined,
          isTimeKeeper: "false",
        },
  });

  const [showJudgeLevel, setShowJudgeLevel] = useState(
    official ? official.isJudge : false
  );
  const [showCourseDesignerLevel, setShowCourseDesignerLevel] = useState(
    official ? official.isCourseDesigner : false
  );
  const [showStewardLevel, setShowStewardLevel] = useState(
    official ? official.isSteward : false
  );
  ...
  return (
    <Form {...form}>
      <form
        ...
        className={cn("space-y-4 flex flex-col items-center", "md:space-y-8")}
      >
        <div
          className={cn(
